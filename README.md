...
[![GoDoc](https://pkg.go.dev/badge/github.com/dojimanetwork/solana-go?status.svg)](https://pkg.go.dev/github.com/dojimanetwork/solana-go@v1.11.0?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/dojimanetwork/solana-go/releases)
[![Build Status](https://github.com/dojimanetwork/solana-go/workflows/tests/badge.svg?branch=main)](https://github.com/dojimanetwork/solana-go/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/dojimanetwork/solana-go/main)](https://www.tickgit.com/browse?repo=github.com/dojimanetwork/solana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/dojimanetwork/solana-go)](https://goreportcard.com/report/github.com/dojimanetwork/solana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/dojimanetwork/solana-go/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/dojimanetwork/solana-go@v1.11.0
```
...
You can wait for a transaction confirmation using the `github.com/dojimanetwork/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/dojimanetwork/solana-go/programs/address-lookup-table"
...
import (
  ...
  "github.com/dojimanetwork/solana-go"
  "github.com/dojimanetwork/solana-go/programs/system"
  "github.com/dojimanetwork/solana-go/rpc"
  "github.com/dojimanetwork/solana-go/text"
)
...
import (
  ...
  "github.com/dojimanetwork/solana-go/rpc"
  "github.com/dojimanetwork/solana-go/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/dojimanetwork/solana-go/programs/system"
  "github.com/dojimanetwork/solana-go/rpc"
  confirm "github.com/dojimanetwork/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/dojimanetwork/solana-go/rpc/jsonrpc"
  "github.com/dojimanetwork/solana-go/rpc/ws"
  "github.com/dojimanetwork/solana-go/text"
)
...
import (
  ...
  "github.com/davecgh/go-spew/spew"
  bin "github.com/gagliardetto/binary"
  solana "github.com/dojimanetwork/solana-go"
  "github.com/dojimanetwork/solana-go/programs/token"
  "github.com/dojimanetwork/solana-go/rpc"
)
